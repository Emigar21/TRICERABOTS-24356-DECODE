...
@Autonomous(name="Red Auto High", group="red")
public class Red_Alliance_Auto_High extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        chassis.mecanumDriveByTime(-.3,0,1.28); // Drive right to next artifact row // 1.28 alta, 1.95 baja
        ...
        chassis.mecanumDriveByTime(0,-.22,.8);
        ...
        chassis.mecanumTurnByTime(-.25,1.15); // Turn to goal // 1.15 alta, 1.2 baja
