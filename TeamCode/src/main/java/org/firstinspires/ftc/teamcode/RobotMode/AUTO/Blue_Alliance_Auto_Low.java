...
public class Blue_Alliance_Auto_Low extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        chassis.mecanumTurnByTime(-.25,.85); // Spin to look towards next artifact row

        chassis.mecanumDriveByTime(.3,0,1.76); // Drive left to next artifact row // 1.2 alta, 2.05 baja
        ...
        chassis.mecanumDriveByTime(0,-.22,.6);
